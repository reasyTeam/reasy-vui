<template>
  ...
  >
    <div
      :class="['vui-loading', { 'vui-loading-max': size === 'max' }]"
      v-show="visible"
    >
      <div
        v-if="type === typeMap.loading"
        class="vui-max-wrapper spinner spinner-ios"
      >
      ...
      <div class="vui-max-wrapper" v-else-if="size === 'max'">
        <i :class="['vui-loading-icon', `vui-icon-${typeIcon[type]}`]"></i>
      </div>

      <div v-if="message" class="vui-loading-tips">
        <i :class="['vui-loading-icon', `vui-icon-${icon}`]" v-if="icon"></i>
  ...
  methods: {
    ...
    handleAfterLeave() {
      ...
      if (this.type === this.typeMap.loading) {
        document.querySelector("[vui-mask]").remove();
      }
    },
    handleBeforeEnter() {
      ...
      if (this.type === this.typeMap.loading) {
        ...
        el.setAttribute("vui-mask", "");
        el.className = "vui-loading-mask";
