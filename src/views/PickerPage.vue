<template>
  <vui-page title="联动，多列选择 vui-picker">
    ...
    <div class="demo-row">
      ...
      ></vui-picker>
      <vui-picker
        label="confirmColor：#f00"
        confirmColor="#f00"
        v-model="link"
        :options="linkArray"
      ></vui-picker>
      <vui-picker
        label="cancelColor：#f00"
        cancelColor="#f00"
        v-model="link"
        :options="linkArray"
      ></vui-picker>
